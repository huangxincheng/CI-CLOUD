package com.husen.ci.sso.utils;
...
public class JedisUtils {
    ...
    private static ShardedJedis getInstance() {
                ...
                if (INSTANCE_INIT_LOCL.tryLock(2, TimeUnit.SECONDS)) {
                    try {
                        if (shardedJedisPool == null) {
                            ...
                            log.info(">>>>>>>>>>> sso, JedisUtils.ShardedJedisPool init success.");
                        }
                    } finally {
        ...
        if (shardedJedisPool == null) {
            throw new NullPointerException(">>>>>>>>>>> sso, JedisUtils.ShardedJedisPool is null.");
        }
    ...
    public static void main(String[] args) {
        ...
        xxlSsoRedisAddress = "redis://redis.limaila.com:6379/0";
